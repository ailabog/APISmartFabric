...
public class Endpoints {
    public static final String middleURLUser = "/catalogs/admin/users/";
    public static final String middleURLLogin = "/catalogs/auth/tenant-user-login";
    public static final String middleURLAdminGroups = "/catalogs/admin/groups/";
    public static final String middleURLAdminGroupsUsers = "/catalogs/admin/groups/users/";
    public static final String middleURLAdminTenants = "/catalogs/admin/tenants/";
    public static final String middleURLAdminTenantsUsers = "/catalogs/admin/tenants/users/";
    public static final String middleURLSystem = "/catalogs/auth/system-user-login";
    public static final String middleURLTenant = "/catalogs/auth/tenant-anon-login/";
    public static final String middleURLTenantsUsersSystem = "/catalogs/tenants/users/system";
    public static final String middleURLTenantsGroups = "/catalogs/tenants/groups/";
    public static final String middlerURLTenantsGroupsPermissions = "/catalogs/tenants/groups/permissions";
    public static final String middleURLTennatsGroupsUsers = "/catalogs/tenants/groups/user";
    public static final String middleURLTenantsUserGroups = "/catalogs/tenants/user-groups/";
    public static final String middleURLTenantsUsers = "/catalogs/tenants/users/";
    public static final String middleURLTenantsUsersAvatars = "/catalogs/tenants/users/avatars";
    public static final String middleURLTenantsUsersEmailByEmail = "/catalogs/tenants/users/email/";
    public static final String middleURLTenantsUsersGroups = "/catalogs/tenants/users/group/";
    public static final String middleURLTenantsUsersList = "//catalogs/tenants/users/list";
    public static final String middleURLTenantsUsersManager = "/catalogs/tenants/users/manager/";
    public static final String middleURLTenantsUsersProfile = "/catalogs/tenants/users/profile";
    public static final String middleURLTenantsUsersProfileNotification = "/catalogs/tenants/users/profile/notification";
    public static final String middleURLTenantsUsersTenants = "/catalogs/tenants/users-tenants";
    ...
    public static final String middleURLDataCatalogsContentLoadVersion1 = "/data/identity/content/load/version/";
    public static final String middleURLDataCatalogsContentLoadVersion2 = "/processDefinition/";
    public static final String middleURLDataCatalogsContentSaveVersion1 = "/data/identity/content/save/version/";
    public static final String middleURLDataCatalogsContentSaveVersion2 = "/processDefinition/";
    public static final String middleURLDataCatalogsDefinitionVersion1 = "/data/identity/definition/version/";
    public static final String middleURLDataCatalogsDefinitionVersion2 = "/processDefinition/";
    public static final String middleURLCatalogsExportJson = "/data/identity/content/export/json/processDefinition/";
    public static final String middleURLCatalogsContentExportVersion = "/data/identity/content/export/version/";
    public static final String middleURLCatalogsContentImportVersion = "/data/identity/content/import/version/";
