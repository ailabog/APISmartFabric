...
public class Identity_Tenants_Group_AdminUITest {
    ...
    @Test
    public void postIdentityTenantsGroupAdmin() throws JsonProcessingException {
    ...
    @Test
    public void postWrongIdentityTenantsGroupAdmin() throws JsonProcessingException {
    ...
    @Test
    public void postIdentityTenantsGroupAdminNoAuthentication() throws JsonProcessingException {
        given()
                .contentType(ContentType.JSON).body(mapper.writeValueAsString(tenantsGroup)).when()
                .post(CredentialsUtils.IDENTITY + Endpoints.middleURLIdentityTenantsGroupAdminUI).then()
                .statusCode(401);
