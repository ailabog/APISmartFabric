...
@Slf4j
public class Catalog_Data_LoadData_ProcessInstance_By_ProcessInstanceId_Gui_By_GuiIdTest {
	...
	public void postCatalogDataLoadDataProcessInstanceByProcessInstanceIdGuiByGuiId() throws JsonProcessingException {
		...
		ValidatableResponse vr =
				given().header(PRINCIPAL_HEADER_NAME, Constants.PRINCIPAL_HEADER_VALUE)
						...
						.post(CredentialsUtils.CATALOGS + Endpoints.middleURLDataLoadDataProcessInstanceGUI + processInstanceId +
