...
public class Identity_Tenants_UsersTest23 {
	...
	private static final Logger logger = LoggerFactory.getLogger(Identity_Tenants_UsersTest23.class);
	...
	public void getTenantsUsers() throws FileNotFoundException {
		...
		logger.info("Identity_Tenants_Users" + CredentialsUtils.getProperty("baseURL")
