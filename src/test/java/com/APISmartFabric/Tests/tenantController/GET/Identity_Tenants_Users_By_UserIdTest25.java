...
public class Identity_Tenants_Users_By_UserIdTest25 {
	...
	private static final Logger logger = LoggerFactory.getLogger(Identity_Tenants_Users_By_UserIdTest25.class);
	...
	public void getTenantsUsersByUserId() throws FileNotFoundException {
		...
		logger.info("Identity_Tenants_Users_By_UserId" + CredentialsUtils.getProperty("baseURL")
				+ CredentialsUtils.getProperty("middleURLTenantsUsers") + USERS.USER_OK1.getId());
	}
