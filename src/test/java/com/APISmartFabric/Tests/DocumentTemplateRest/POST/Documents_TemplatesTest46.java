	...
	public void postDocumentsTemplates() {
		...
		given().header("principal",
				...
				.body("{\"description\" :\"" + documentsTemplates.getDescription() + "\", \n" + "\"h\":\""
						...
						+ documentsTemplates.getIsAdvanced() + "\"iteration\":\"" + documentsTemplates.getIteration()
						+ "\", \n" + "\"name\":\"" + documentsTemplates.getName() + "\"ownerId\":\""
						+ documentsTemplates.getOwnerId() + "\", \n" + "\"processDefinitionId\":\""
						+ documentsTemplates.getProcessDefinitionId() + "\", \n" + "\"template\":\""
						+ documentsTemplates.getTemplate() + "\", \n" + "\"usedAttributes\":\""
						+ documentsTemplates.getUsedAttributes() + "\", \n" + "\"versionId\":\""
						+ documentsTemplates.getVersionId() + "\", \n" + "\"w\":\"" + documentsTemplates.getW()
						+ "\" }")
				.when().post(CredentialsUtils.getProperty("baseURLDocuments")
